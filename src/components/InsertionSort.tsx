...
function InsertionSort({ items, maxVal, maxHeight }: AlgoComponentProps) {
    return (
                    ...
                    return (
                        ...
                        >
                            <motion.div
                                ...
                                animate={{
                                    height: barHeight,
                                    backgroundColor: item.sorted ? "#82C47E" : item.inComparison ? "#FFB200" : "#E8E8E8",
                                    borderColor: item.sorted ? "#468F42" : item.inComparison ? "#A37200" : "#5C5C5C",
                                }}
